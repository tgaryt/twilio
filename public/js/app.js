...
class TwilioClientApp {
	...
	async activateDialer() {
		try {
			document.getElementById('activate-dialer-btn').disabled = true;
			document.getElementById('activate-dialer-btn').innerHTML = `
			...
			document.getElementById('activate-dialer-btn').disabled = false;
			document.getElementById('activate-dialer-btn').innerHTML = `
